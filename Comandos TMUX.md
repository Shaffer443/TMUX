...
Para dividir a tela com __dois painéis horizontais__ use o comando:
...
- Criar Aba Inferior:
uma divisão de painéis superior e inferior.
```
ctrl + b + "
```
...
$ tmux a 
```
**Visualizar terminais rodando em segundo plano:**
...
- Navegando dieratamente para uma cojunto de terminais:
0:bash - numero do terminal 0
1:bash - numero do terminal 1
```
